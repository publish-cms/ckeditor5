 ...
 * An array containing available video style options.
 ...
 *
 * @param {Array.<module:video/videostyle~VideoStyleOptionDefinition>} styles
 * Video style options for which the converter is created.
...
export function viewToModelStyleAttribute( styles ) {
	...
	return ( evt, data, conversionApi ) => {
		...
		// Run this converter only if an video has been found in the model.
		// In some cases it may not be found (for example if we run this on a figure with different type than video).
...
// @param {String} name
// @param {Array.<module:video/videostyle~VideoStyleOptionDefinition> } styles
// @returns {module:video/videostyle~VideoStyleOptionDefinition|undefined}
